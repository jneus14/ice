...
const en: T = {
  ...
  tags: {
    incidentTypes: {
      ...
      "Injury/Illness/Medical": "Injury/Illness/Medical",
      "Officer Misconduct": "Officer Misconduct",
      "Officer Use Of Force": "Officer Use of Force",
      "Protest / Intervention": "Protest/Intervention",
      "Raid": "Raid",
      "State/Local Collusion": "State/Local Collusion",
      "Vigilante": "Vigilante/Bounty Hunter Action",
    },
    personImpacted: {
      "DACA": "DACA/Dreamer",
      "LGBTQ+": "LGBTQ+",
...
const es: T = {
  ...
  tags: {
    incidentTypes: {
      ...
      "Injury/Illness/Medical": "Lesión/Enfermedad/Médico",
      "Officer Misconduct": "Mala conducta policial",
      "Officer Use Of Force": "Uso de fuerza por agentes",
      "Protest / Intervention": "Protesta/Intervención",
      "Raid": "Redada",
      "State/Local Collusion": "Colusión estatal/local",
      "Vigilante": "Acción de vigilante/cazarrecompensas",
    },
    personImpacted: {
      "DACA": "DACA/Soñador/a",
      "LGBTQ+": "LGBTQ+",
      "LPR": "Residente permanente",
      "Minor/Family": "Menor/Familia",
