...

{
  ...
  "incidentType": "Comma-separated tags from ONLY these options. INCIDENT TYPE: Detained, Deported, Death, Detention Conditions, Officer Use Of Force, Officer Misconduct, Policy/Stats, Family Separation, Minor/Family, U.S. Citizen, Protest / Intervention, Raid, Resistance, Resources, Refugee/Asylum, DACA, Visa / Legal Status, LPR, TPS, Court Process Issue, Court Order Violation, Litigation, 3rd Country Deportation, Native American, Indigenous (Non-U.S.), Vigilante, Disappearance/Detention. ENFORCEMENT SETTING (pick at most ONE): Court/USCIS/Immigration Office, Airport, Vehicle/Traffic Stop, Workplace, School, Church/Place of Worship, Hospital/Medical, Home/Residence, Jail/Prison, Public Space/Street, Shelter. PERSON IMPACTED: DACA/Dreamer, LGBTQ+, LPR/Greencard, Minor, Native American (U.S.), Indigenous (Non-U.S.), Person with Disability, Refugee/Asylum Seeker, Student, Temporary Protected Status, U.S. Citizen, Protester/Intervenor, Palestine Advocate, Visa/Legal Status",
